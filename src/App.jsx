...
//   // invoked by SearchBar (when user selects a city)
...
//   // invoked by MapWithGeolocator (map passes {lat, lon, name, weather?})
//   async function handleMapLocationSelect(obj) {
//     if (!obj) return;
//     const { lat, lon, name } = obj;
//     // If map already attached weather, use it; otherwise fetch
//     if (obj.weather) {
...
//       <h2 style={{ margin: 0 }}>WeatherApp</h2>
//       <small className="p-ml-3 p-text-secondary">React · PrimeReact · Leaflet</small>
//     </div>
//   );

//   return (
//     <>
//       <Toolbar left={leftToolbar} right={<Button label="About" className="p-button-text" />} />
//       <div className="p-grid p-m-3" style={{ gap: "1rem" }}>
